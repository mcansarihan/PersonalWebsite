...
<body>
    ...
    <header class="jumbotron">
        <div class="container">
            <div class="row row-header">
                ...
                <div class="col-12 col-sm-3 align-self-center">
                    <input onClick="document.getElementById('ReserveTableForm').scrollIntoView();" type="button" class="btn btn-warning btn-block" value="Reserve Table">
                </div>
        ...
        <div class="row row-content align-items-center">
            ...
            <div class="col col-sm col-md ">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h2 class="mt-0 d-inline-block">Weekend Grand Buffet <span class="badge badge-danger align-text-top ">NEW</span></h2>
                    ...
                    <img class="d-flex  img-thumbnail align-self-center" src="img/buffet.png" alt="buffet">
                </div>
            </div>
        </div>
    ...
    <div class="row row-content align-self-center">
        <div class="col-9 col-md-5 offset-md-3 offset-1">
            <div class="card">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="form-check form-check-inline ">
                                    ...
                                    <label class="form-check-label" for="number1">1</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="number" id="number2" value="2">
                                    <label class="form-check-label" for="number2">2</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="number" id="number3" value="3">
                                    <label class="form-check-label" for="number3">3</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="number" id="number4" value="4">
                                    <label class="form-check-label" for="number4">4</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="number" id="number5" value="5">
                                    <label class="form-check-label" for="number5">5</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="number" id="number6" value="6">
                                    <label class="form-check-label" for="number6">6</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-4 align-self-center">
                    <div class="text-center">
                        ...
                        <a class="btn btn-social-icon " href="mailto:"><i class="fa fa-envelope-o fa-lg"
